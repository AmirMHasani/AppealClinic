...
/**
 * Always ensure demo@appealclinic.local + default settings + AppMeta exist
 * before verifyCredentials / any store read. Upsert so first login on a
 * fresh Postgres works even if other rows already exist.
 */
